...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendMessage(View view) {
        ...
        //PUT request
        String url = "https://iotpcf.apps.dev.pcf-aws.com/device";
   ...
   /*     Intent intent = new Intent(this, DisplayMessageActivity.class);
    ...
    public void sendActivity(View view) {
        ...
        try{
            jsonBodyObj.put("deviceID", myDeviceID);
            jsonBodyObj.put("activity", "CPU50");
            jsonBodyObj.put("action", "NOTIFY");
        }catch (JSONException e){
            e.printStackTrace();
        }
        final String requestBody = jsonBodyObj.toString();
        ...
        //PUT request
        String url = "https://iotpcf.apps.dev.pcf-aws.com/device/activity";
        StringRequest putRequest = new StringRequest(Request.Method.PUT, url,
                new Response.Listener<String>()
                {
                    @Override
